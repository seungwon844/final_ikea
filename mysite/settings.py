...
DISQUS_WEBSITE_SHORTNAME = 's71oie2'   # (ch08) 3/4 [Website Name]
...
MEDIA_URL = '/media/'                             # 추가 (교과서 40 쪽)  # 업로드된 사진을 저장할 폴더
MEDIA_ROOT = os.path.join(BASE_DIR, 'media')   # 추가 (교과서 40 쪽)  # 업로드된 사진을 저장할 폴더
# 여기 ROOT에서 [] 안에 넣어버리면 오류 발생함!

LOGIN_REDIRECT_URL = '/'  # 11장 추가